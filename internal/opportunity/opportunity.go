...
type Opportunity struct {
	...
	Recommendation string     `json:"recommendation,omitempty"` // BID, NO_BID, or REVIEW
	ScoreReasoning string     `json:"score_reasoning"`          // LLM's reasoning for the score
	Requirements   []string   `json:"requirements,omitempty"`   // Must-have requirements extracted from solicitation
