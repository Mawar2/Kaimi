...
func TestLoadProfile_RealProfile(t *testing.T) {
	// The real profile is in the root directory, two levels up from this test file.
	...
	// Verify NAICS count: 1 primary + 5 secondary + 3 tertiary = 9
	...
	// Verify the 5 required past performance entries
